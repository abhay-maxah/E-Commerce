...
export const generateInvoice = async (req, res) => {
    try {
        ...
        doc.text("Email: support@cookiesman.com | Phone: +91 98765 43210", { align: "center" });
        doc.moveDown();
        ...
        doc.text(`Address: ${order.address.houseName}, ${order.address.streetAddress}`);
        ...
        doc.fontSize(14).fillColor("black").text(`Total Amount: ${fallbackRupeeText} ${calculatedTotal.toFixed(2)}`);
        doc.text(`Discount: ${fallbackRupeeText} ${discount.toFixed(2)}`);
        doc.fontSize(16).fillColor("#A31621").text(`Payable Amount: ${fallbackRupeeText} ${payableAmount.toFixed(2)}`, { bold: true });
        doc.moveDown(1);
        ...
        doc.text("Enjoy your delicious cookies and visit our online store again!", { align: "center" });
