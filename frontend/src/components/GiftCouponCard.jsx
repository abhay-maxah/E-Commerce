      ...
      <div className="space-y-4">
        <div>
          ...
          <input
            ...
            p-2.5 text-sm  placeholder-gray-400 "
      ...
      {isCouponApplied && coupon && (
        <div className="mt-4">
          ...
          <motion.button
            ...
            px-5 py-2.5 text-sm font-medium g-transparent border border-[#A31621] hover:bg-[#A31621] hover:text-white focus:outline-none
